...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Compliance Disco — DPDP Command Center" },
      {
        name: "description",
        content:
          "Multi-agent compliance command center that reads India's DPDP Act and tells Engineering and Marketing what they must change.",
      },
